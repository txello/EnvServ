...
from envserv import errors
from envserv.typing.variable import Variable
from envserv.get.variables import EnvType
...
class EnvBase:
    ...
    def json(self) -> str:
        return json.dumps(self.all(toString=True))
